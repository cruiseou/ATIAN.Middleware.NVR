...
namespace ATIAN.Middleware.NVR.Http
{
    ...
    public class HTTPS
    {
        ...
        //设置编码
        public static void SetEncoding(string endcode)
        {
            requestEncoding = Encoding.GetEncoding(endcode);
        }
        ...
        {
            if (!String.IsNullOrWhiteSpace(userAgent)) requestUserAgent = userAgent;
            else requestUserAgent = DefaultUserAgent;
        }
        ...
        /// <returns></returns>
        public static HttpWebResponse CreateGet(string url, int? timeout = null, string userAgent = null,
        ...
        /// <returns></returns>
        public static HttpWebResponse CreatePost(string url, string datas = null, int? timeout = null,
            string headers = null)
        {
        ...
        /// <returns></returns>
        public static HttpWebResponse Create(string url, string datas = null, string method = "GET",
            Encoding requestEncoding = null, int? timeout = null, string headers = null, bool AllowAutoRedirect = true)
        {
        ...
        {
            HttpWebResponse rq = HTTPS.Create("GET", url, null, null, null, heads);
